                ...
                ${NavTop.render()}
                    <main class="p-4">
                        <div class="flex justify-between">
                            ...
                            <div>
                                <a href="/#/admin-add-product" class="uppercase bg-blue-500 p-2 text-white rounded font-medium hover:bg-blue-600">
                                    <span>add product</span>
                                </a>
                            </div>
                        </div>
                        <div class="grid grid-cols-8 gap-5 py-2" id="list-product">
